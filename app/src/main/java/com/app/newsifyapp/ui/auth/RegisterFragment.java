...
import com.app.newsifyapp.databinding.FragmentRegisterBinding;
                                    ...
                                    .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onComplete(@NonNull Task<AuthResult> task) {
                                            if (task.isSuccessful()) {
                                                NavHostFragment.findNavController(RegisterFragment.this).navigate(R.id.action_registerFragment_to_dashboardFragment);
                                            } else {
